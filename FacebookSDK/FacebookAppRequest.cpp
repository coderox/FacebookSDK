...
namespace winrt::FacebookSDK::implementation
{
	...
	FacebookSDK::FacebookAppRequest FacebookAppRequest::FromRequestDialogResponse(Windows::Foundation::Uri const& response)
	{
		FacebookSDK::FacebookAppRequest info{ nullptr };
		hstring requestId;
		...
		return info.as<FacebookSDK::FacebookAppRequest>();
	}
