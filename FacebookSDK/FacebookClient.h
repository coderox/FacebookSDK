...
#include "FacebookClient.g.h"
#include "HttpMethod.h"
#include <ppltasks.h>

namespace winrt::FacebookSDK::implementation
{
	struct FacebookClient : FacebookClientT<FacebookClient>
	{
...
{
	struct FacebookClient : FacebookClientT<FacebookClient, implementation::FacebookClient>
	{
	};
}
