...
namespace winsdkfb_Tests
{
	...
	public:
		TEST_METHOD(TestCreateFBUserFromJson)
		{
			...
			// act
			auto user = dynamic_cast<winsdkfb::Graph::FBUser^>(winsdkfb::Graph::FBUser::FromJson(json));
		...
		TEST_METHOD(TestCreateFBProfilePictureFromJson)
		{
			...
			// act
			auto profilePicture = dynamic_cast<winsdkfb::Graph::FBProfilePicture^>(winsdkfb::Graph::FBProfilePicture::FromJson(json));
		...
		TEST_METHOD(TestCreateFBProfilePictureDataFromJson)
		{
			...
			// act
			auto profilePicture = dynamic_cast<winsdkfb::Graph::FBProfilePictureData^>(winsdkfb::Graph::FBProfilePictureData::FromJson(json));
