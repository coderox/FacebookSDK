...
namespace winrt::winsdkfb::implementation
{
	...
	winsdkfb::FacebookAccessTokenData FacebookSession::AccessTokenData()
	{
		return _AccessTokenData;
	}

	void FacebookSession::AccessTokenData(winsdkfb::FacebookAccessTokenData const& value)
	{
	...
	winsdkfb::Graph::FBUser FacebookSession::User()
	{
		return _user;
	}
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::ShowFeedDialogAsync(PropertySet const Parameters)
	{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::ShowRequestsDialogAsync(PropertySet const Parameters)
	{
		winsdkfb::FacebookResult result{ nullptr };
		FacebookDialog dialog;
		try {
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::ShowSendDialogAsync(PropertySet const Parameters)
	{
		winsdkfb::FacebookResult result{ nullptr };
		FacebookDialog dialog;
		try {
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::LoginAsync()
	{
		return LoginAsync(nullptr, winsdkfb::SessionLoginBehavior::DefaultOrdering);
	}

	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::LoginAsync(winsdkfb::FacebookPermissions permissions)
	{
		return LoginAsync(permissions, winsdkfb::SessionLoginBehavior::DefaultOrdering);
	}

	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::LoginAsync(winsdkfb::FacebookPermissions permissions, winsdkfb::SessionLoginBehavior behavior)
	{
		if (!permissions) {
	...
	winsdkfb::FacebookSession FacebookSession::ActiveSession()
	{
		static winsdkfb::FacebookSession activeFBSession = make<FacebookSession>();
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryRefreshAccessTokenAsync()
	{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::GetUserInfoAsync(
		winsdkfb::FacebookAccessTokenData const& tokenData
	) {
		PropertySet parameters;
		...
		winsdkfb::FacebookSingleValue value = make<FacebookSingleValue>(
			L"/me",
			parameters,
			objectFactory);
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::CheckForExistingTokenAsync()
	{
		winsdkfb::FacebookResult result{ nullptr };
		if (LoggedIn())
		{
			...
			try {
				...
				if (item != nullptr) {
					...
					if (pos != wstring::npos)
					{
						...
						winsdkfb::FacebookAccessTokenData cachedData = make<FacebookAccessTokenData>(accessToken, expirationTime);
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::GetAppPermissionsAsync()
	{
	...
	winsdkfb::FacebookResult FacebookSession::ProcessAuthResult(WebAuthenticationResult authResult)
	{
		winsdkfb::FacebookResult result{ nullptr };
		hstring uriString;
		winsdkfb::FacebookAccessTokenData tokenData{ nullptr };
		Uri uri{ nullptr };
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryGetUserInfoAfterLoginAsync(winsdkfb::FacebookResult loginResult)
	{
		winsdkfb::FacebookResult result{ nullptr };

		if (loginResult != nullptr && loginResult.Succeeded())
		{
			_AccessTokenData = loginResult.Object().as<winsdkfb::FacebookAccessTokenData>();
			_loggedIn = true;
			TrySaveTokenData();
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryGetAppPermissionsAfterLoginAsync(winsdkfb::FacebookResult loginResult)
	{
		winsdkfb::FacebookResult result{ nullptr };
		if (loginResult != nullptr && loginResult.Succeeded())
		{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::RunOAuthOnUiThreadAsync(PropertySet Parameters)
	{
		try
		{
			_asyncResult = nullptr;
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::RunWebViewLoginOnUIThreadAsync(PropertySet Parameters)
	{
		try
		{
			_asyncResult = nullptr;
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::ShowLoginDialogAsync(PropertySet const& Parameters)
	{
		winsdkfb::FacebookResult result{ nullptr };
		FacebookDialog dialog;
		try {
		...
		if (result.Succeeded())
		{
			AccessTokenData(result.Object().as<winsdkfb::FacebookAccessTokenData>());
		}

		co_return result;
	}

	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryLoginViaWebViewAsync(
		PropertySet parameters
	) {
		winsdkfb::FacebookResult loginResult{ nullptr };
		auto session = FacebookSession::ActiveSession();
		...
		if (!IsRerequest(parameters)) {
			...
			if (oauthResult != nullptr && oauthResult.Succeeded()) {
				if (winsdkfb::FacebookAccessTokenData tokenData{ oauthResult.Object().try_as<winsdkfb::FacebookAccessTokenData>() }) {
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryLoginViaWebAuthBrokerAsync(
		PropertySet parameters
	) {
		winsdkfb::FacebookResult loginResult{ nullptr };
		auto session = FacebookSession::ActiveSession();
		...
		if (!IsRerequest(parameters)) {
			auto oauthResult = co_await CheckForExistingTokenAsync();
			if (oauthResult != nullptr && oauthResult.Succeeded()) {
				auto tokenData = oauthResult.Object().as<winsdkfb::FacebookAccessTokenData>();
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryLoginSilentlyAsync(
		PropertySet parameters
	) {
		winsdkfb::FacebookResult loginResult{ nullptr };
		auto session = FacebookSession::ActiveSession();
		...
		winsdkfb::FacebookResult oauthResult{ nullptr };
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::CheckWebAccountProviderForExistingTokenAsync(
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::TryLoginViaWebAccountProviderAsync(
		winsdkfb::FacebookPermissions permissions
	) {
		return CheckWebAccountProviderForExistingTokenAsync(permissions);
	}

	IAsyncOperation<winsdkfb::FacebookResult> FacebookSession::CallWebAccountProviderOnUiThreadAsync(
		winsdkfb::FacebookPermissions permissions
	) {
		_asyncResult = nullptr;
		auto asyncEvent = CreateEvent(nullptr, true, false, nullptr);
		auto function = [](FacebookSession *self, HANDLE event, winsdkfb::FacebookPermissions const& permissions) -> IAsyncAction {
			try {
				auto provider = co_await WebAuthenticationCoreManager::FindAccountProviderAsync(FBAccountProvider);
				WebTokenRequestResult result = nullptr;
				if (provider) {
	...
	winsdkfb::FacebookResult FacebookSession::ExtractAccessTokenDataFromResponseData(
	...
	winsdkfb::FacebookResult FacebookSession::FacebookResultFromTokenRequestResult(
