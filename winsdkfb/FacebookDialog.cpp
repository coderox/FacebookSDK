...
namespace winrt::winsdkfb::implementation
{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookDialog::ShowLoginDialogAsync(PropertySet const parameters)
	{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookDialog::ShowFeedDialogAsync(PropertySet const parameters)
	{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookDialog::ShowRequestsDialogAsync(PropertySet const parameters)
	{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookDialog::ShowSendDialogAsync(PropertySet const parameters)
	{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookDialog::ShowDialog(
	...
	void FacebookDialog::SetDialogResponse(winsdkfb::FacebookResult dialogResponse) {
