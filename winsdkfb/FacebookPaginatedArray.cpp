...
{
	FacebookPaginatedArray::FacebookPaginatedArray(hstring const& request, PropertySet const& parameters, winsdkfb::JsonClassFactory const& objectFactory)
		: _current(nullptr)
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookPaginatedArray::FirstAsync()
	{
		return GetPageAsync(_request);
	}

	IAsyncOperation<winsdkfb::FacebookResult> FacebookPaginatedArray::NextAsync()
	{
		if (!HasNext())
		{
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookPaginatedArray::PreviousAsync()
	{
		if (!HasPrevious())
		{
	...
	IVectorView<IInspectable> FacebookPaginatedArray::ObjectArrayFromWebResponse(hstring const& Response, winsdkfb::JsonClassFactory const& classFactory)
	{
	...
	winsdkfb::FacebookResult FacebookPaginatedArray::ConsumePagedResponse(
		wstring jsonText
	) {
	...
	IAsyncOperation<winsdkfb::FacebookResult> FacebookPaginatedArray::GetPageAsync(wstring path) {
