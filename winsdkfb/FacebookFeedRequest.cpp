...
namespace winrt::winsdkfb::implementation
{
	...
	winsdkfb::FacebookFeedRequest FacebookFeedRequest::FromFeedDialogResponse(Windows::Foundation::Uri const& response)
	{
		winsdkfb::FacebookFeedRequest info = { nullptr };
