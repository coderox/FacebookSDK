...
namespace winrt::winsdkfb::implementation
{
	...
	winsdkfb::FacebookPermissions FacebookPermissions::FromString(hstring const& permissions)
	{
		return make<FacebookPermissions>(ParsePermissionsFromString(permissions));
	}

	winsdkfb::FacebookPermissions FacebookPermissions::Difference(winsdkfb::FacebookPermissions const& Minuend, winsdkfb::FacebookPermissions const& Subtrahend)
	{
