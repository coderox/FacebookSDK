...
namespace winrt::winsdkfb::implementation
{
	...
	winsdkfb::FacebookError FacebookError::FromUri(Uri const& ResponseUri)
	{
		...
		return result.as<winrt::winsdkfb::FacebookError>();
	}

	winsdkfb::FacebookError FacebookError::FromJson(hstring const& JsonText)
	{
