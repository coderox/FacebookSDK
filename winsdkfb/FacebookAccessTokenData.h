...
namespace winrt::winsdkfb::implementation
{
	struct FacebookAccessTokenData : FacebookAccessTokenDataT<FacebookAccessTokenData>
	{
		...
		winsdkfb::FacebookPermissions GrantedPermissions();
		winsdkfb::FacebookPermissions DeclinedPermissions();
		bool IsExpired();
		void SetPermissions(Windows::Foundation::Collections::IVectorView<Windows::Foundation::IInspectable> const& perms);

		static winsdkfb::FacebookAccessTokenData FromUri(Windows::Foundation::Uri const& Response);
	...
	private:
		...
		winsdkfb::FacebookPermissions _grantedPermissions{ nullptr };
		winsdkfb::FacebookPermissions _declinedPermissions{ nullptr };
	};
}
